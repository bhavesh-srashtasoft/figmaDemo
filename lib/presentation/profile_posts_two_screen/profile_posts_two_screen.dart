                  ...
                  Container(
                      ...
                      child:
                        ...
                        Align(
                            ...
                            child: Padding(
                                padding:
                                    getPadding(left: 108, top: 10, right: 108),
                                child: ClipRRect(
                                                                ...
                                                                Container(
                                                                    ...
                                                                    child: Stack(
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                              alignment: Alignment.centerLeft,
                                                                              child: Container(height: getVerticalSize(83.00), width: size.width, decoration: BoxDecoration(color: ColorConstant.gray50))),
                                                                          Padding(
                                                                              padding: getPadding(left: 26, top: 14, right: 26, bottom: 14),
                                                                              child: Container(width: getHorizontalSize(320.00), height: getVerticalSize(32.00), child: Obx(() => PinCodeTextField(appContext: context, controller: controller.otpController.value, length: 5, obscureText: false, obscuringCharacter: '*', keyboardType: TextInputType.number, autoDismissKeyboard: true, enableActiveFill: true, inputFormatters: [FilteringTextInputFormatter.digitsOnly], onChanged: (value) {}, pinTheme: PinTheme(fieldHeight: getHorizontalSize(32.00), fieldWidth: getHorizontalSize(32.00), shape: PinCodeFieldShape.circle, selectedFillColor: ColorConstant.green400, activeFillColor: ColorConstant.green400, inactiveFillColor: ColorConstant.green400, inactiveColor: ColorConstant.fromHex("#1212121D"), selectedColor: ColorConstant.fromHex("#1212121D"), activeColor: ColorConstant.fromHex("#1212121D"))))))
                                                                        ]))
                                                              ])))
                                                ])))
                                  ]))))
